...
form.addEventListener('submit', function (event) {
    ...
    requisicao.open('GET', `https://api.nasa.gov/planetary/apod?api_key=HxfsjMvsjh9PJ6dPJ40ikaqugjUIAJgQbjK8QVN3&date=${input.value}`);
    requisicao.send();
});
...
requisicao.open("GET", `https://api.nasa.gov/planetary/apod?api_key=HxfsjMvsjh9PJ6dPJ40ikaqugjUIAJgQbjK8QVN3`);
